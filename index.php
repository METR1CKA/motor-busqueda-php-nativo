  ...
  if (!$db->checkConnection()) {
    echo "<script type='text/javascript'>alert('Error al conectar la BD');</script>";
    return;
  }
  ...
  if (isset($_POST['buscar_web'])) {
    ...
    $responseErr = $data['Response'] == 'False';
  ...
  if (isset($_SESSION['movie_name_web'])) {
  ...
  if (isset($_POST['show_favoritos'])) {
    ...
    if (!$favoritos) {
      echo "<script type='text/javascript'>alert('Error al obtener favoritos');</script>";
      return;
    }
  }
  ?>
